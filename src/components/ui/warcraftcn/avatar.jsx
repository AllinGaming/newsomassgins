    ...
    <div className={cn(frameClasses, className)} {...props}>
      <div className="absolute inset-[20%] overflow-hidden">
        {src ? (
          ...
          <div
            className="flex items-center justify-center w-full h-full text-2xl select-none">
            {fallback}
          </div>
        ) : null}
      </div>
      <div
        className="pointer-events-none absolute inset-0 scale-[1.05] wc-avatar-frame" />
    </div>
  );
};
